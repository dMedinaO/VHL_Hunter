...
@Component({
  selector: 'app-table-resume-eff',
  templateUrl: './table-resume-eff.component.html',
  styleUrls: ['./table-resume-eff.component.css']
})
export class TableResumeEffComponent implements OnInit {
  /*Datatable*/
  ...
  getResumeVHL(){
    return this._mutationService.getResumeEff().subscribe(
      response=>{
        this.data = []
